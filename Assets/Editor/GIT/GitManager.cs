...
namespace UniGit
{
	public static class GitManager
	{
		...
		internal static void Initlize()
		{
			...
			gitCredentials = Resources.Load<GitCredentials>("Git-Credentials");
			gitSettings = Resources.Load<GitSettings>("Git-Settings");
			if (gitSettings == null)
			{
			...
			if (icons == null)
			{
				icons = new Icons()
				{
					validIcon = EditorGUIUtility.IconContent("success"),
					validIconSmall = EditorGUIUtility.IconContent("success_small"),
					modifiedIcon = EditorGUIUtility.IconContent("error"),
					modifiedIconSmall = EditorGUIUtility.IconContent("error_small"),
					addedIcon = EditorGUIUtility.IconContent("add"),
					addedIconSmall = EditorGUIUtility.IconContent("add_small"),
					untrackedIcon = EditorGUIUtility.IconContent("info"),
					untrackedIconSmall = EditorGUIUtility.IconContent("info_small"),
					ignoredIcon = EditorGUIUtility.IconContent("minus"),
					ignoredIconSmall = EditorGUIUtility.IconContent("minus_small"),
					conflictIcon = EditorGUIUtility.IconContent("warning"),
					conflictIconSmall = EditorGUIUtility.IconContent("warning_small"),
					deletedIcon = EditorGUIUtility.IconContent("deleted"),
					deletedIconSmall = EditorGUIUtility.IconContent("deleted_small"),
					renamedIcon = EditorGUIUtility.IconContent("renamed"),
					renamedIconSmall = EditorGUIUtility.IconContent("renamed_small")
				};
			}
