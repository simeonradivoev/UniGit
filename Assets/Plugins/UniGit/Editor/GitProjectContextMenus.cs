...
namespace UniGit
{
	...
	{
		[MenuItem("Assets/Git/Add", priority = 50)]
		...
		[MenuItem("Assets/Git/Add", true, priority = 50)]
		...
		[MenuItem("Assets/Git/Remove", priority = 50)]
		...
		[MenuItem("Assets/Git/Remove", true, priority = 50)]
		...
		[MenuItem("Assets/Git/Difference", priority = 65)]
		...
		[MenuItem("Assets/Git/Revert",true, priority = 80)]
